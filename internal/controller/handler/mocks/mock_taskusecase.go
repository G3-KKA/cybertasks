...
func (_m *MockTaskUsecase) DeleteTask(ctx context.Context, id uint64) error {
...
func (_m *MockTaskUsecase) GetTask(ctx context.Context, id uint64) (model.Task, error) {
	ret := _m.Called(ctx, id)
	...
	var r0 model.Task
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64) (model.Task, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64) model.Task); ok {
		r0 = rf(ctx, id)
	} else {
